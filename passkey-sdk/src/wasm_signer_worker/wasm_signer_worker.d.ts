...
export class RegistrationResult {
  free(): void;
  constructor(verified: boolean, registration_info: RegistrationInfoStruct | null | undefined, logs: string[], signed_transaction?: WasmSignedTransaction | null, pre_signed_delete_transaction?: WasmSignedTransaction | null, error?: string | null);
  verified: boolean;
  get registrationInfo(): RegistrationInfoStruct | undefined;
  set registrationInfo(value: RegistrationInfoStruct | null | undefined);
  logs: string[];
  get signedTransaction(): WasmSignedTransaction | undefined;
  set signedTransaction(value: WasmSignedTransaction | null | undefined);
  get preSignedDeleteTransaction(): WasmSignedTransaction | undefined;
  set preSignedDeleteTransaction(value: WasmSignedTransaction | null | undefined);
  get error(): string | undefined;
  set error(value: string | null | undefined);
}
/**
...
export interface InitOutput {
  ...
  readonly __wbg_signverifyandregisteruserrequest_free: (a: number, b: number) => void;
  readonly __wbg_get_signverifyandregisteruserrequest_verification: (a: number) => number;
  readonly __wbg_set_signverifyandregisteruserrequest_verification: (a: number, b: number) => void;
  readonly __wbg_get_signverifyandregisteruserrequest_decryption: (a: number) => number;
  readonly __wbg_set_signverifyandregisteruserrequest_decryption: (a: number, b: number) => void;
  readonly __wbg_get_signverifyandregisteruserrequest_registration: (a: number) => number;
  readonly __wbg_set_signverifyandregisteruserrequest_registration: (a: number, b: number) => void;
  readonly __wbg_registrationresult_free: (a: number, b: number) => void;
  readonly __wbg_get_registrationresult_verified: (a: number) => number;
  readonly __wbg_set_registrationresult_verified: (a: number, b: number) => void;
  readonly __wbg_get_registrationresult_registrationInfo: (a: number) => number;
  readonly __wbg_set_registrationresult_registrationInfo: (a: number, b: number) => void;
  readonly __wbg_get_registrationresult_logs: (a: number) => [number, number];
  readonly __wbg_set_registrationresult_logs: (a: number, b: number, c: number) => void;
  readonly __wbg_get_registrationresult_signedTransaction: (a: number) => number;
  readonly __wbg_set_registrationresult_signedTransaction: (a: number, b: number) => void;
  readonly __wbg_get_registrationresult_preSignedDeleteTransaction: (a: number) => number;
  readonly __wbg_set_registrationresult_preSignedDeleteTransaction: (a: number, b: number) => void;
  readonly __wbg_get_registrationresult_error: (a: number) => [number, number];
  readonly __wbg_set_registrationresult_error: (a: number, b: number, c: number) => void;
  readonly registrationresult_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
