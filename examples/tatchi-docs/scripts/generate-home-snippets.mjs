...
async function main() {
  ...
  const reactHtmlLight = highlighter.codeToHtml(reactSnippet, { lang: 'tsx', theme: 'github-light-default' })
  const reactHtmlDark  = highlighter.codeToHtml(reactSnippet, { lang: 'tsx', theme: 'github-dark-default' })
  const coreHtmlLight  = highlighter.codeToHtml(coreSnippet,   { lang: 'ts',  theme: 'github-light-default' })
  const coreHtmlDark   = highlighter.codeToHtml(coreSnippet,   { lang: 'ts',  theme: 'github-dark-default' })
  const installHtmlLight = highlighter.codeToHtml(installSnippet, { lang: 'bash', theme: 'github-light-default' })
  const installHtmlDark  = highlighter.codeToHtml(installSnippet, { lang: 'bash', theme: 'github-dark-default' })
