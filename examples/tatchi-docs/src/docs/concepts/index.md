...
Applications onborading non-crypto users should not require users to download two separate applications (the app itself, plus a wallet). Tatchi solves this by embedding the wallet directly in your application.
...
For detailed technical documentation on security architecture, cryptographic primitives, and smart contract integration, see [Architecture](architecture) section.
