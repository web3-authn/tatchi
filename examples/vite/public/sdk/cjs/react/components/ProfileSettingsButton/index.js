...
const require_UserAccountButton = require('./UserAccountButton.js');
const require_ProfileDropdown = require('./ProfileDropdown2.js');
const require_useProfileState = require('./hooks/useProfileState.js');
const require_ThemeProvider = require('../theme/ThemeProvider.js');
const require_QRCodeScanner = require('../QRCodeScanner.js');
const require_AccessKeysModal = require('./AccessKeysModal2.js');
require('./Web3AuthProfileButton.js');
...
const ProfileSettingsButtonInner = ({ username: usernameProp, nearAccountId: nearAccountIdProp, onLogout, toggleColors, nearExplorerBaseUrl = "https://nearblocks.io", deviceLinkingScannerParams }) => {
	const { loginState, passkeyManager, logout, useRelayer, setUseRelayer } = require_index.usePasskeyContext();
	...
	const [showQRScanner, setShowQRScanner] = (0, react.useState)(false);
	const [showAccessKeys, setShowAccessKeys] = (0, react.useState)(false);
	const [isLoadingKeys, setIsLoadingKeys] = (0, react.useState)(false);
	const [transactionSettingsOpen, setTransactionSettingsOpen] = (0, react.useState)(false);
	const [currentConfirmConfig, setCurrentConfirmConfig] = (0, react.useState)(null);
	(0, react.useEffect)(() => {
		try {
	...
	const MENU_ITEMS = (0, react.useMemo)(() => [
		{
			icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Key, {}),
			label: "Export Keys",
		...
		{
			icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Scan, {}),
		...
		{
			icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Shield, {}),
			label: "Access Keys",
		...
		{
			icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Sliders, {}),
	...
	const { isOpen, refs, handleToggle, handleClose } = require_useProfileState.useProfileState();
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_UserAccountButton.UserAccountButton, {
					...
					nearExplorerBaseUrl,
					theme
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_ProfileDropdown.ProfileDropdown, {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_QRCodeScanner.QRCodeScanner, {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_AccessKeysModal.AccessKeysModal, {
				nearAccountId,
...
const ProfileSettingsButton = (props) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_ThemeProvider.ThemeProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_ThemeProvider.ThemeScope, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProfileSettingsButtonInner, { ...props }) }) });
};

//#endregion
exports.ProfileSettingsButton = ProfileSettingsButton;
