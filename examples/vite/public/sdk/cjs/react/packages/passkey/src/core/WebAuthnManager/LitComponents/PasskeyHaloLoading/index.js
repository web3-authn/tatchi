...
var PasskeyHaloLoadingElement = class extends require_LitElementWithProps.LitElementWithProps {
	static properties = {
  ...
  `;
	render() {
      ...
      <div class="w3a-passkey-loading-root ${theme}">
        ...
        >
          <div class="w3a-passkey-loading-touch-icon-container" style=${require_style_map.o(iconContainerStyle)}>
	...
	renderTouchIcon({ height, width }) {
		...
		return require_lit_html.x`
      <svg
        style=${require_style_map.o(iconStyle)}
        width=${width}
        height=${height}
        viewBox="0 0 24 24"
        fill="none"
...
//#endregion
exports.default = PasskeyHaloLoading_default;
