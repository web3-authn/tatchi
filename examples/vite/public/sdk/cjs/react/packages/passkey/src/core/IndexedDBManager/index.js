const require_passkeyClientDB = require('./passkeyClientDB.js');
const require_passkeyNearKeysDB = require('./passkeyNearKeysDB.js');

//#region src/core/IndexedDBManager/index.ts
const passkeyClientDB = new require_passkeyClientDB.PasskeyClientDBManager();
const passkeyNearKeysDB = new require_passkeyNearKeysDB.PasskeyNearKeysDBManager();
/**
