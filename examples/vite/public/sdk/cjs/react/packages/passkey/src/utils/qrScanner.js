...
const require_linkDevice = require('../core/types/linkDevice.js');
...
function createQRError(message) {
	return new require_linkDevice.DeviceLinkingError(message, require_linkDevice.DeviceLinkingErrorCode.INVALID_QR_DATA, "authorization");
}

//#endregion
exports.ScanQRCodeFlow = ScanQRCodeFlow;
exports.ScanQRCodeFlowState = ScanQRCodeFlowState;
exports.detectFrontCamera = detectFrontCamera;
exports.enumerateVideoDevices = enumerateVideoDevices;
exports.scanQRCodeFromFile = scanQRCodeFromFile;
