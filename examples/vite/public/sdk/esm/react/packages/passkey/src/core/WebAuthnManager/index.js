...
import nonceManager_default from "../nonceManager.js";
...
var WebAuthnManager = class {
	...
	*/
	...
	constructor(passkeyManagerConfigs, nearClient) {
		...
		this.signerWorkerManager = new SignerWorkerManager(this.vrfWorkerManager, nearClient, userPreferences_default, nonceManager_default);
