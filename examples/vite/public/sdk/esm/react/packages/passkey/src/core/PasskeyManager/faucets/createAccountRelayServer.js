...
import { removePrfOutputGuard, serializeRegistrationCredential } from "../../WebAuthnManager/credentialsHelpers.js";
...
async function createAccountAndRegisterWithRelayServer(context, nearAccountId, publicKey, credential, vrfChallenge, deterministicVrfPublicKey, authenticatorOptions, onEvent) {
	...
	try {
		...
		const serializedCredential = removePrfOutputGuard(serializeRegistrationCredential(credential));
		const requestData = {
...
//#endregion
export { createAccountAndRegisterWithRelayServer };
