...
import { DEFAULT_AUTHENTICATOR_OPTIONS } from "../types/authenticatorOptions.js";
import { getOptimalCameraFacingMode } from "../../react/deviceDetection.js";
import { MinimalNearClient } from "../NearClient.js";
import { ActionType } from "../types/actions.js";
import { WebAuthnManager } from "../WebAuthnManager/index.js";
import { ActionPhase, ActionStatus, DeviceLinkingPhase } from "../types/passkeyManager.js";
import { registerPasskey } from "./registration.js";
import { getLoginState, getRecentLogins, loginPasskey, logoutAndClearVrfSession } from "./login.js";
import { executeAction, sendTransaction, signAndSendTransactions, signTransactionsWithActions } from "./actions.js";
import { AccountRecoveryFlow } from "./recoverAccount.js";
import { DeviceLinkingError, DeviceLinkingErrorCode } from "../types/linkDevice.js";
import { LinkDeviceFlow } from "./linkDevice.js";
import { linkDeviceWithQRCode } from "./scanDevice.js";
import { ScanQRCodeFlow, ScanQRCodeFlowState } from "../../utils/qrScanner.js";
import { signNEP413Message } from "./signNEP413.js";
import { ServiceIframeClient } from "../ServiceIframe/client.js";
...
var PasskeyManager = class {
	...
	*/
	async registerPasskey(nearAccountId, options) {
		return registerPasskey(this.getContext(), toAccountId(nearAccountId), options, this.configs.authenticatorOptions || DEFAULT_AUTHENTICATOR_OPTIONS);
	}
	/**
	...
	*/
	async getLoginState(nearAccountId) {
		return getLoginState(this.getContext(), nearAccountId ? toAccountId(nearAccountId) : void 0);
	}
	/**
