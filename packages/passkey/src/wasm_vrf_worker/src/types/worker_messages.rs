...
impl From<u32> for WorkerRequestType {
    fn from(value: u32) -> Self {
        match value {
            ...
            7 => WorkerRequestType::ComputeTxActionsDigest,
            8 => WorkerRequestType::Shamir3PassClientEncryptCurrentVrfKeypair,
            9 => WorkerRequestType::Shamir3PassClientDecryptVrfKeypair,
            10 => WorkerRequestType::Shamir3PassGenerateServerKeypair,
            11 => WorkerRequestType::Shamir3PassApplyServerLock,
            12 => WorkerRequestType::Shamir3PassRemoveServerLock,
            13 => WorkerRequestType::Shamir3PassConfigP,
            14 => WorkerRequestType::Shamir3PassConfigServerUrls,
...
impl From<&str> for WorkerRequestType {
    fn from(value: &str) -> Self {
        match value {
            ...
            "COMPUTE_TX_ACTIONS_DIGEST" => WorkerRequestType::ComputeTxActionsDigest,
...
impl WorkerRequestType {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            WorkerRequestType::ComputeTxActionsDigest => "COMPUTE_TX_ACTIONS_DIGEST",
