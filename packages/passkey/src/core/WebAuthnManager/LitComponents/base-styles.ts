...
export const CHROMA_COLORS = {
  ...
  yellow50: 'oklch(0.97 0.050 95)',    // lightest
  ...
  red950: 'oklch(0.22 0.040 19)',   // darkest

  // Violet color scale from lightest to darkest
  violet50: 'oklch(0.97 0.042 305)',    // lightest
